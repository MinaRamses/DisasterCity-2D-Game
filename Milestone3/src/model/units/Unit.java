...
public abstract class Unit implements Simulatable, SOSResponder {
	...
	public boolean canTreat(Rescuable r) {
		...
		if (r instanceof Citizen) {
			...
			if (b.getDisaster() instanceof Collapse && this instanceof Evacuator) {
				return true;
			} else if (b.getDisaster() instanceof Fire && this instanceof FireTruck)
				return true;
			else if (b.getDisaster() instanceof GasLeak && this instanceof GasControlUnit)
				return true;
